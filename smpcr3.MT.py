...
## SMPCR library method by D Chung, M Toney (UC Davis)
## Calculate the distribution of mutations for each round of SMPCR
## Code written by: Krishna Ravikumar (07/23/2016)
